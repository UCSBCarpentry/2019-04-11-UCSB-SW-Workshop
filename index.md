...
venue: "UCSB Library Software Carpentry Workshop &quot;R&quot;, Git and Bash"        # brief name of host site without address (e.g., "Euphoric State University")
address: "University of California, Santa Barbara Library Classroom 1312 (Day 1) Classroom 1575 (Day 2), Santa Barbara, CA 93106"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "April 11-12, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Noah Spahn (R)", "Kristi Liu (RF)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: ["https://pad.carpentries.org/2019-04-11-ucsb"] # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "58740790285"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% comment %}
  ...
  If you want to use an Etherpad, go to
      ...
      http://pad.software-carpentry.org/2019-04-11-site
...
<p id="collaborative_notes">
  Etherpad: We will use this <a href="{{page.collaborative_notes}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
{% endif %}
